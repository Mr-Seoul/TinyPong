...
module GraphicsProcessor(
  ...
  wire [4:0] _GEN_4 = P2_io_inbound ? P2_io_diffX : 5'h0; // @[\\src\\main\\scala\\vga\\GraphicsProcessor.scala 75:30 76:15]
  wire [4:0] inputAbsX = P1_io_inbound ? P1_io_diffX : _GEN_4; // @[\\src\\main\\scala\\vga\\GraphicsProcessor.scala 70:24 71:15]
  wire [4:0] _GEN_12 = {{1'd0}, BaysianDither}; // @[\\src\\main\\scala\\vga\\GraphicsProcessor.scala 68:29]
  wire  dithered = inputAbsX <= _GEN_12; // @[\\src\\main\\scala\\vga\\GraphicsProcessor.scala 68:29]
...
`ifdef RANDOMIZE_REG_INIT
  ...
  reg [31:0] _RAND_1;
`endif // RANDOMIZE_REG_INIT
  wire  graphics_clock; // @[\\src\\main\\scala\\vga\\VGAModule.scala 27:24]
  wire [1:0] graphics_io_col_R; // @[\\src\\main\\scala\\vga\\VGAModule.scala 27:24]
  wire [1:0] graphics_io_col_G; // @[\\src\\main\\scala\\vga\\VGAModule.scala 27:24]
  wire [1:0] graphics_io_col_B; // @[\\src\\main\\scala\\vga\\VGAModule.scala 27:24]
  wire [10:0] graphics_io_indexX; // @[\\src\\main\\scala\\vga\\VGAModule.scala 27:24]
  wire [9:0] graphics_io_indexY; // @[\\src\\main\\scala\\vga\\VGAModule.scala 27:24]
  wire  graphics_io_screenDone; // @[\\src\\main\\scala\\vga\\VGAModule.scala 27:24]
  wire  graphics_io_input1; // @[\\src\\main\\scala\\vga\\VGAModule.scala 27:24]
  wire  graphics_io_input2; // @[\\src\\main\\scala\\vga\\VGAModule.scala 27:24]
  wire  debouncer1_clock; // @[\\src\\main\\scala\\vga\\VGAModule.scala 35:26]
  wire  debouncer1_reset; // @[\\src\\main\\scala\\vga\\VGAModule.scala 35:26]
  wire  debouncer1_io_in; // @[\\src\\main\\scala\\vga\\VGAModule.scala 35:26]
  wire  debouncer1_io_out; // @[\\src\\main\\scala\\vga\\VGAModule.scala 35:26]
  wire  debouncer2_clock; // @[\\src\\main\\scala\\vga\\VGAModule.scala 36:26]
  wire  debouncer2_reset; // @[\\src\\main\\scala\\vga\\VGAModule.scala 36:26]
  wire  debouncer2_io_in; // @[\\src\\main\\scala\\vga\\VGAModule.scala 36:26]
  wire  debouncer2_io_out; // @[\\src\\main\\scala\\vga\\VGAModule.scala 36:26]
  wire  TimingModule_io_hsync; // @[\\src\\main\\scala\\vga\\VGAModule.scala 48:28]
  wire  TimingModule_io_vsync; // @[\\src\\main\\scala\\vga\\VGAModule.scala 48:28]
  wire [10:0] TimingModule_io_indexX; // @[\\src\\main\\scala\\vga\\VGAModule.scala 48:28]
  wire [9:0] TimingModule_io_indexY; // @[\\src\\main\\scala\\vga\\VGAModule.scala 48:28]
  ...
  GraphicsManager graphics ( // @[\\src\\main\\scala\\vga\\VGAModule.scala 27:24]
  ...
  DebouncerModule debouncer1 ( // @[\\src\\main\\scala\\vga\\VGAModule.scala 35:26]
    .clock(debouncer1_clock),
    .reset(debouncer1_reset),
    .io_in(debouncer1_io_in),
    .io_out(debouncer1_io_out)
  );
  DebouncerModule debouncer2 ( // @[\\src\\main\\scala\\vga\\VGAModule.scala 36:26]
    .clock(debouncer2_clock),
    .reset(debouncer2_reset),
    .io_in(debouncer2_io_in),
    .io_out(debouncer2_io_out)
  );
  VGATimingModule TimingModule ( // @[\\src\\main\\scala\\vga\\VGAModule.scala 48:28]
  ...
  assign io_col_R = graphics_io_col_R; // @[\\src\\main\\scala\\vga\\VGAModule.scala 43:12]
  assign io_col_G = graphics_io_col_G; // @[\\src\\main\\scala\\vga\\VGAModule.scala 44:12]
  assign io_col_B = graphics_io_col_B; // @[\\src\\main\\scala\\vga\\VGAModule.scala 45:12]
  assign io_hsync = TimingModule_io_hsync; // @[\\src\\main\\scala\\vga\\VGAModule.scala 51:12]
  assign io_vsync = TimingModule_io_vsync; // @[\\src\\main\\scala\\vga\\VGAModule.scala 52:12]
  assign graphics_clock = clock;
  assign graphics_io_indexX = {{1'd0}, hCounter}; // @[\\src\\main\\scala\\vga\\VGAModule.scala 30:22]
  assign graphics_io_indexY = vCounter; // @[\\src\\main\\scala\\vga\\VGAModule.scala 31:22]
  assign graphics_io_screenDone = wrap_wrap & wrap_wrap_1; // @[src/main/scala/chisel3/util/Counter.scala 118:{16,23} 117:24]
  assign graphics_io_input1 = debouncer1_io_out; // @[\\src\\main\\scala\\vga\\VGAModule.scala 41:22]
  assign graphics_io_input2 = debouncer2_io_out; // @[\\src\\main\\scala\\vga\\VGAModule.scala 42:22]
  ...
  assign debouncer2_io_in = io_input2; // @[\\src\\main\\scala\\vga\\VGAModule.scala 38:20]
  assign TimingModule_io_indexX = {{1'd0}, hCounter}; // @[\\src\\main\\scala\\vga\\VGAModule.scala 49:26]
  assign TimingModule_io_indexY = vCounter; // @[\\src\\main\\scala\\vga\\VGAModule.scala 50:26]
  always @(posedge clock) begin
