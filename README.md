...
The chip has a 63% logic utilisation, and a 92% overall utilisation. The cocotb tests pass, and the STA/GLS don't give any errors besides one large fanout (likely the synched reset being funneled to all registers, which isn't an issue overall). 
